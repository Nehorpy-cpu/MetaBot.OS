    ...
    <Modal title="Accesos al portal de los profesionales" onClose={onClose}>
      <div className="space-y-5">
        <p className="text-xs text-zinc-400 leading-relaxed">
          ...
          <strong className="text-zinc-200"> solo sus pacientes</strong>: el resumen del día y
        ...
        <section className="space-y-2">
          ...
          {accesos.length === 0 && (
            <p className="text-xs text-zinc-600">Todavía no le diste acceso a nadie.</p>
          )}
          {accesos.map((a) => (
            <div key={a.doctor_id}
              ...
              <span className="text-sm text-zinc-200 flex items-center gap-2">
                <ShieldCheck size={13} className="text-emerald-400" /> {a.doctor}
              </span>
        ...
        {reciente && (
          <div className="bg-cyan-500/5 border border-cyan-500/30 rounded-xl p-4 space-y-2">
            ...
            {reciente.clave ? (
              <>
                <div className="flex items-center gap-2">
                  <code className="bg-black/40 px-3 py-1.5 rounded-lg text-sm text-white font-mono select-all">
                    {reciente.clave}
                  </code>
