...
import {
  api, type AgentDetail, type AgentSummary, type Appointment, type Company,
  type DailySummary, type DashboardData, type Doctor, STATUS_ES,
} from "./api";
...
export default function App() {
  ...
  const [view, setView] = useState<"dashboard" | "agents" | "medical">("dashboard");
