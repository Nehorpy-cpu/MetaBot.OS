...
from .routers import agents, bridge, campaigns, chat, companies, creatives, dashboard, glossary, intelligence, medical, services, whatsapp_webhook
from .scheduler import start_scheduler

Base.metadata.create_all(bind=engine)

app = FastAPI(title="MetaBot.OS", version="0.10.0")
for router in (companies.router, agents.router, medical.router, glossary.router, dashboard.router, chat.router, whatsapp_webhook.router, bridge.router, intelligence.router, creatives.router, campaigns.router, services.router):
